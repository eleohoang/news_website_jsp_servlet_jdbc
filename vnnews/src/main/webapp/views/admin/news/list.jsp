		...
		function deleteNew(data) {
			$.ajax({
				...
				success: function (result) {
					window.location.href = "${NewURL}?type=list&page=1&maxPageItem=5&sortName=title&sortBy=asc&message=delete_success&alert=success";
				},
				error: function (error) {
					window.location.href = "${NewURL}?type=list&page=1&maxPageItem=5&sortName=title&sortBy=asc&message=error_system&alert=danger";
				}
			 });
		}
	</script>
